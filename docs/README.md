...
| [`../docs-estudar/GUIA_ENTREVISTA.md`](../docs-estudar/GUIA_ENTREVISTA.md) | Explicação didática, perguntas e roteiro de estudo pessoal. Não é contrato do sistema. | Preparação para entrevista. |
...
### Estudo para apresentação

Leia `docs-estudar/GUIA_ENTREVISTA.md`, desenhe os fluxos sem consultar o arquivo e
depois abra os testes ou constraints citados para provar cada afirmação.
